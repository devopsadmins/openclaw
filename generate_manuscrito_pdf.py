...
output_pdf = "livros/ninguem_precisa_saber/MANUSCRITO_FINAL.pdf"
input_md = "livros/ninguem_precisa_saber/MANUSCRITO_NINGUEM_PRECISA_SABER.md"
...
styles.add(ParagraphStyle(name='NoirHeading', parent=styles['Heading1'], fontSize=18, leading=22, spaceAfter=10))
